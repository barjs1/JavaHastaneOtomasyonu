...
public class HastaGUI extends JFrame {
	...
	public HastaGUI(Hasta hasta) throws SQLException {
		...
		Object[] colDoctor = new Object[2]; // gösterilecek kolonlar
		colDoctor[0] = "ID";
		...
		Object[] colWhour = new Object[2]; // gösterilecek kolonlar
		colWhour[0] = "ID";
		colWhour[1] = "Tarih";
		...
		Object[] colAppoint = new Object[3]; // gösterilecek kolonlar
		colAppoint[0] = "ID";
		colAppoint[2] = "Doktor";
		colAppoint[1] = "Tarih";
		...
		JLabel lblNewLabel = new JLabel("Hosşgeldiniz Sayın "+hasta.getName());
		...
		w_scrollDoctor.setBounds(0, 37, 299, 302);
		...
		lblNewLabel_1.setBounds(10, 11, 200, 22);
		...
		lblNewLabel_1_4.setBounds(313, 35, 150, 24);
		w_appointment.add(lblNewLabel_1_4);
		
		select_clinic = new JComboBox();
		select_clinic.setBounds(309, 52, 150, 32);
		...
		lblNewLabel_1_4_1.setBounds(309, 95, 150, 24);
		...
		btn_selDoctor.setFont(new Font("Arial", Font.BOLD, 20));
		btn_selDoctor.setBackground(UIManager.getColor("Button.darkShadow"));
		btn_selDoctor.setBounds(309, 117, 126, 32);
		w_appointment.add(btn_selDoctor);
		
		JScrollPane w_scrollWhour = new JScrollPane();
		w_scrollWhour.setBounds(475, 37, 225, 302);
		...
		lblNewLabel_1_1.setBounds(474, 11, 200, 22);
		...
		btn_addAppoint.setFont(new Font("Arial", Font.BOLD, 14));
		btn_addAppoint.setBackground(UIManager.getColor("Button.darkShadow"));
		btn_addAppoint.setBounds(309, 192, 126, 32);
		w_appointment.add(btn_addAppoint);
		
		JLabel lblNewLabel_1_4_1_1 = new JLabel("Randevu ");
		lblNewLabel_1_4_1_1.setFont(new Font("Yu Gothic", Font.BOLD, 15));
		lblNewLabel_1_4_1_1.setBounds(309, 170, 150, 24);
	...
	public void updateAppointModel(int hasta_id) throws SQLException {
		...
		for (int i = 0; i < appoint.getHastaList(hasta.getId()).size(); i++) {
			appointData[0]=appoint.getHastaList(hasta.getId()).get(i).getId();
			appointData[0]=appoint.getHastaList(hasta.getId()).get(i).getDoctorName();
			appointData[0]=appoint.getHastaList(hasta.getId()).get(i).getAppDate();
			appointModel.addRow(appointData);
